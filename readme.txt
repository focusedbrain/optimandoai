...
📘 Paper v196: The Official Canon
The foundation of this repository is the cornerstone scientific and normative work: "WR Code™ – Browser-Based Multi-Agent Orchestration for Contextual Workflow Automation" (v196).
...
The documentation and protocol definitions (Paper v196) are licensed under the WR Code™ Canonical Specification License (CSL-1.2).
...
🔗 Citation & Contact
Schreyer, O. (2025). WR Code™ – Browser-Based Multi-Agent Orchestration for Contextual Workflow Automation (v196). Optimando.ai.
