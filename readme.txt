...
📘 Paper v193: The Official Canon
The foundation of this repository is the cornerstone scientific and normative work: "WR Code™ – Browser-Based Multi-Agent Orchestration for Contextual Workflow Automation" (v193).
...
The documentation and protocol definitions (Paper v193) are licensed under the WR Code™ Canonical Specification License (CSL-1.2).
...
🔗 Citation & Contact
Schreyer, O. (2025). WR Code™ – Browser-Based Multi-Agent Orchestration for Contextual Workflow Automation (v193). Optimando.ai.
