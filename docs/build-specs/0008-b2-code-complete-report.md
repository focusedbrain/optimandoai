...
**Status: CODE-COMPLETE, NOT ACCEPTED.** (Briefly reclassified to "code-complete
except D4–D6" by spec `0010`; those deviations — D4 structured-json guest walker,
D5 residual parse removal + guard, D6 bundle uplift — are now **closed** by the
B2.1 remainder build, report `0012`, restoring the code-complete claim honestly.)
