# Optimando Desktop App Starter
Write-Host "🚀 Starting Optimando Desktop App..." -ForegroundColor Green
...
Write-Host "✅ Optimando Desktop App started in background" -ForegroundColor Green
