 ...
 * 
 * Run with: pnpm dev (in apps/glassview-app)
 */
...
import { 
  ...
  OrchestratorBridge 
} from '@wrcode/code-block-library';

// Import the GlassView template as raw text
// Vite handles this with ?raw suffix
import glassviewTemplateText from '../../packages/code-block-library/src/templates/glassview.template.md?raw';
