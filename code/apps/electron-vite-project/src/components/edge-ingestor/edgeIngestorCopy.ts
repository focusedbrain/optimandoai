...
export const EDGE_INGESTOR_NOT_CONFIGURED_TITLE = 'Edge Ingestor is not configured'

export const EDGE_INGESTOR_NOT_CONFIGURED_BODY =
  'Start the wizard to deploy the edge ingestor with the depackaging unit and validator off band on a VPS server.'
