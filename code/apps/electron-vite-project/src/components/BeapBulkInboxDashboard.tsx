...
export default function BeapBulkInboxDashboard({
  ...
  const { openConnectEmail, connectEmailFlowModal } = useConnectEmailFlow({
    ...
    theme: 'professional',
    ingestionStatus: beapBulkIngestionStatus ?? undefined,
  })
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        {!beapBulkIsSandbox && composeMode === 'beap' ? (
          <div
            style={{
              position: 'absolute',
              inset: 0,
        ...
        ) : !beapBulkIsSandbox && composeMode === 'email' ? (
          <div
            style={{
              position: 'absolute',
              inset: 0,
      ...
      {/* Compose buttons — bottom-right: P3 sandbox UI: absent on sandbox */}
      {!beapBulkIsSandbox && (
