...
export interface EmailInboxBridge {
  ...
  getInboxSettings: () => Promise<{ ok: boolean; data?: { tone: string; sortRules: string; contextDocs: unknown[]; batchSize: number; aiSecurityProvider: { kind: string; model?: string; endpoint?: string } }; error?: string }>
  setInboxSettings: (partial: { tone?: string; sortRules?: string; batchSize?: number; aiSecurityProvider?: { kind: string; model?: string; endpoint?: string } }) => Promise<{ ok: boolean; error?: string }>
