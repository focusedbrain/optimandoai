...
export const VAULT_ACCOUNT_ERROR = {
  ...
  CLAIM_NOT_LEGACY: 'ERR_VAULT_CLAIM_NOT_LEGACY',
  CLAIM_ALREADY_OWNED: 'ERR_VAULT_CLAIM_ALREADY_OWNED',
  CLAIM_WRONG_PASSPHRASE: 'ERR_VAULT_CLAIM_WRONG_PASSPHRASE',
  CLAIM_WRITE_FAILED: 'ERR_VAULT_CLAIM_WRITE_FAILED',
  CLAIM_NO_SESSION: 'ERR_VAULT_CLAIM_NO_SESSION',
} as const
