 ...
 * Per chunk, see **`aiClassifyBatch:ipc`** (`wallMs`, **`preResolveMs`**, **`ollamaPrewarm`** — first-chunk load/cooldown, **`maxInFlightSeenDuringChunk`**) and **`aiClassifyBatch:perMessage`** (**`sumMs` overlaps parallel work**).
 */
