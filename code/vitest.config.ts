...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      /** Pod/vault decoupling — must not load test/setup.ts mock pod; see vitest.podVault.config.ts */
      'apps/electron-vite-project/electron/main/local-pod/__tests__/podVaultDecoupling.test.ts',
    ],
    server: {
      deps: {
